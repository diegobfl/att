...
struct npc_wildaAI : public npc_escortAI
{
    ...
    void DoFreeSpirits()
    {
        ...
        for (Creature* spirit : lSpiritsInRange)
        {
            ...
            spirit->StopMoving();
            /// Removing This since it's crashing when you follow. Doing a follow with a NPC that doesn't have motion generator. 
            ...
            /// Hack Fix, removing this to make water elementals to not attack. That way avoiding the bug where they don't follow.
